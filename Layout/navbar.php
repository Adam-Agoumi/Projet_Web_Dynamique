...
<body>
<nav class="navbar navbar-custom fixed-top navbar-expand bg-primary justify-content-between px-5">

    <!-- Links -->
    <ul class="navbar-nav" >
        <a class="navbar-brand"><img src="../assets/img/logo.png" height=50></a>
        <li class="nav-item">
            <a class="nav-link nav-link-custom text-light" href="../Layout/register.php">Inscription</a>
        </li>
        <li class="nav-item">
            <a class="nav-link nav-link-custom text-light" href="#">Connection</a>
        </li>
        <li class="nav-item">
    ...
    <div>
        <span class="navbar-text ms-5 me-2 text-light">Jhonny Appleseed</span>
        <button class="btn btn-custom btn-success">Logout</button>
    </div>
</nav>
...
<div class="info-container">
    <div class="title-container">
        <h1>Informations</h1>
        <div class="button">Précédent</div>
    </div>
    <div class="book-info">
